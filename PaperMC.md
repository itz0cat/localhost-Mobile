# PaperMC Download Links

Click on a version to download the latest PaperMC build.

## Latest Version
- [PaperMC 1.21.4](https://api.papermc.io/v2/projects/paper/versions/1.21.4/builds/130/downloads/paper-1.21.4-130.jar)
